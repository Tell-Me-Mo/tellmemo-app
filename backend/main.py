...
app.include_router(websocket_live_insights.router, tags=["websocket", "live-insights"])
app.include_router(live_insights.router, tags=["live-insights"])
