...
class CreateProgramDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateProgramDialog> createState() => _CreateProgramDialogState();
}
...
class _CreateProgramDialogState extends ConsumerState<CreateProgramDialog> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      await ref.read(programListProvider(portfolioId: _selectedPortfolioId).notifier).createProgram(
      ...
      if (mounted) {
        ...
        // Also invalidate the program list providers
        ref.invalidate(programListProvider(portfolioId: _selectedPortfolioId));
        if (_selectedPortfolioId == null) {
          // Refresh the "no portfolio" programs list as well
          ref.invalidate(programListProvider(portfolioId: null));
        }
      ...
      if (mounted) {
        setState(() {
          ...
          if (errorMsg.contains('already exists')) {
            ...
            _errorMessage = 'Failed to create program. Please try again.';
          }
        });
      }
    }
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                'Portfolio: ${widget.portfolioName}',
                      ...
                      _StyledFormField(
                        ...
                        colorScheme: colorScheme,
                        enabled: !_isLoading,
                        autofocus: widget.portfolioId != null,
                        validator: (value) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Group related projects within a portfolio',
      ...
      child: Row(
        ...
        children: [
          ...
          FilledButton.icon(
            ...
            label: Text(isLoading ? 'Creating...' : 'Create Program'),
