...
class EditProjectFromHierarchyDialog extends ConsumerStatefulWidget {
  final String projectId;

  const EditProjectFromHierarchyDialog({
    super.key,
    required this.projectId,
  });

  @override
  ConsumerState<EditProjectFromHierarchyDialog> createState() => _EditProjectFromHierarchyDialogState();
}

class _EditProjectFromHierarchyDialogState extends ConsumerState<EditProjectFromHierarchyDialog> {
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Program Dropdown (filtered by selected portfolio)
                                          ...
                                          children: [
                                            _StyledDropdown(
                                              ...
                                              items: [
                                                const DropdownMenuItem<String>(
                                                  value: null,
                                                  child: Text('No Program (Direct to Portfolio)'),
                                                ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Update project information and hierarchy',
